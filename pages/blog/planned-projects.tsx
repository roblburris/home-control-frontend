    ...
    return (
        <Template>
            <div>
                ...
                <p>
                    Unlike with my previous website, I decided to add a Blog to my website. Normally, it makes the most sense to use something like WordPress for hosting blogs but since I'm a CS student, I wanted to make my website on my own and use modern frameworks like React. Since I haven't set up Continuous Integration/Continuous Deployment (CI/CD) yet, I have to manually update my website everytime I want to add a new blog post or revise my resume. For making blog posts, this is especially annoying since I have to create a new React component and format everything in JSX. To remedy this, I plan on implementing CI/CD and also creating a Content Management System that can read from something like a Google Doc, create a new React component, and automatically integrate and deploy my changes.
                </p>
            </div>
        </Template>
    );
